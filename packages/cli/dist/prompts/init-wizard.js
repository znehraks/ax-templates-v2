...
export async function runInitWizard(projectName) {
    console.log();
    ...
    if (!answers.geminiSession)
        answers.geminiSession = 'ax-gemini';
    if (!answers.codexSession)
        answers.codexSession = 'ax-codex';
    return answers;
}
// ============================================
...
// ============================================
export function getQuickInitConfig(projectName) {
    return {
        ax_templates: {
            version: '2.0.0',
        },
