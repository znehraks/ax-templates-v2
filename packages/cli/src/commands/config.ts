...
async function executeShow(asJson: boolean = false) {
...
async function executeGet(key?: string, asJson: boolean = false) {
  if (!key) {
...
async function executeSet(key?: string, value?: string) {
